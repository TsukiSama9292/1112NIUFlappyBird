...
void FlappyBird::setSFML(){
  window = new sf::RenderWindow(sf::VideoMode(1000, 600),"111_2NIUFlappy Bird");
  ...
  bird = new sf::Sprite();
  pipeBottom = new sf::Sprite();
  pipeTop = new sf::Sprite();
...
void FlappyBird::movePipes(){
  ...
  if(sf::Keyboard::isKeyPressed(sf::Keyboard::Space)&&bird->getPosition().y>25){
    gravity = -8.f;
