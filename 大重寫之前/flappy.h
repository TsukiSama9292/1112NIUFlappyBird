...
#define BUTTON_START "./AllSundries/image/play.png"
#define BUTTON_ENTER "./AllSundries/image/"
#define BUTTON_RESTART "./AllSundries/image/"
#define BUTTON_HOMEPAGE "./AllSundries/image/"
#define BUTTON_SHOWRANK "./AllSundries/image/"
#define BUTTON_INTRODUCE "./AllSundries/image/"
using namespace std;
using namespace sf;
class FlappyBird : protected setrank{
	...
	SFML_button *btn_play;
	Font font;
	Text text_score, text_gameover;
	Texture bg, bd, pipe,btn;
	Sprite *background, *bird, *pipeBottom, *pipeTop,*sbtn;
	vector<Sprite> pipes;
...
public:
	...
	void setSFML(){ //用於設定初始值
		...
		sbtn=new Sprite();
		sbtn->setTexture(btn);
		SFML_button *btn_play = new SFML_button(BUTTON_START,500,300,window);
	}
